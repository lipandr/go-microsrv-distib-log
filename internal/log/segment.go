...
// The log calls newSegment when it needs to add new segment, such as when
// the current segment hits its max size.
...
// Read returns the record for the given offset. Once it has the index entry,
...
// nearestMultiple(9,4) == 8. We take the lesser muliple to make sure we stay under the user;s disk capacity.
